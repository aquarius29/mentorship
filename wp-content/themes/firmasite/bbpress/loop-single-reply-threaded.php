...
<div class="<?php echo firmasite_social_bbp_get_reply_class_modal();?>">
    ...
    <div class="bbp-reply-meta text-muted pull-right">
        <a href="#<?php bbp_reply_id(); ?>" class="pull-right" data-container="body" data-rel="popover" data-html="true" data-placement="left" data-original-title="" data-content="<?php echo esc_attr($reply_manage); ?>">
