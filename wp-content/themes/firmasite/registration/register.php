		...
		<div class="page" id="register-page">
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_registration_needs_activation() ) : ?>
					<p><?php _e( 'You have successfully registered for the IT Mentorship! To begin using this site you will need to activate your account via the email we have just sent to your address.', "firmasite" ); ?></p>
				<?php else : ?>
