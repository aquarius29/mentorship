...
global $firmasite_showcase, $post, $firmasite_settings;
	...
	?>  
     <div class="jumbotron hero-background clearfix" style="background-image:url(<?php echo $large_image_url[0]; ?>); background-repeat:no-repeat; background-position:center right 15%; <?php  echo $cover;?>">
	<?php } else {  ?>  
