		...
		$wp_customize->add_section( 'showcase-settings', array(
			...
			$wp_customize->add_control( 'firmasite_settings[showcase-calltoaction]', array(
				...
				'priority' => '90',
					...
					<script>
					jQuery(document).ready(function() {
						jQuery('li#customize-control-firmasite_settings-showcase-calltoaction label').prepend('<a href="#" class="popover-gogo pull-right" data-rel="popover" data-trigger="hover" data-placement="left" data-html="true" data-content="<?php 
