        ...
        <header class="archive-header">
            <h1 class="page-header page-title archive-title"><?php
                ...
                elseif ( is_author() ) :
					...
					printf( __( 'All posts by %s', 'firmasite' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( $author->ID ) ) . '" title="' . esc_attr( $author->display_name ) . '" rel="me">' . esc_attr( $author->display_name ) . '</a></span>' ); 
