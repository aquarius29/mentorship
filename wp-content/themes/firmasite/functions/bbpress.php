...
function firmasite_social_bbp_get_topic_freshness_link( $topic_id = 0 ) {
	...
	if ( !empty( $time_since ) )
		$anchor = '<a href="' . $link_url . '" data-rel="popover" data-placement="left" data-trigger="hover" data-html="true" data-original-title="'. __( 'Freshness', "firmasite" ) . '" data-content="' . esc_attr( $time_since ) . '"><i class="icon-time"></i></a>';
	else
...
function firmasite_social_bbp_get_forum_freshness_link( $forum_id = 0 ) {
	...
	if ( !empty( $time_since ) && !empty( $link_url ) )
		$anchor = '<a href="' . $link_url . '" data-rel="popover" data-placement="left" data-trigger="hover" data-html="true" data-original-title="'. __( 'Freshness', "firmasite" ) .'" data-content="' . esc_attr( $time_since ) . '"><i class="icon-time"></i></a>&nbsp;'. __( 'Freshness', "firmasite" ) . ':';
	else
